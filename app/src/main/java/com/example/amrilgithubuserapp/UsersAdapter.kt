...
import kotlinx.android.synthetic.main.baris_user.view.*


class UsersAdapter(private val listusers: ArrayList<UserData>) :
    RecyclerView.Adapter<UsersAdapter.usersadapterViewHolder>() {

     override fun onCreateViewHolder(parent: ViewGroup,viewType: Int): UsersAdapter.usersadapterViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.baris_user, parent, false)
